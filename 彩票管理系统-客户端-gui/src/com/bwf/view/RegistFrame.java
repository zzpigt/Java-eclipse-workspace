...
public class RegistFrame extends javax.swing.JFrame {
     ...
     */
    public RegistFrame(ObjectOutputStream oos){
        initComponents();
        init();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jtfUsername, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
		...
		oos.flush();
     	...
     	synchronized (ClientDemo.class) {
			...
			if (lastResponse.isSuccess()) {
				...
				JOptionPane.showMessageDialog(this, "用户名已名花有主，施主再编一个吧");
				reset();
			}
			//给出提示
...
//            java.util.logging.Logger.getLogger(RegistFrame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new RegistFrame1().setVisible(true);
//            }
//        });
//    }
