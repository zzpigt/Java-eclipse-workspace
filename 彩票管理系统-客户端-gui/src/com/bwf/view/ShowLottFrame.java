 ...
 * @author admin
 */
public class ShowLottFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ShowLottFrame
     */
    public ShowLottFrame(ObjectOutputStream oos,MyResponse lastResponse, String uName) {
    	this.oos = oos;
    ...
    private void init(){
        this.setTitle("往期彩票信息");
        //不可调大小
        this.setResizable(false);
        UiUtil.setFrameCenter(this);
        UiUtil.setFrameImage(this);
        
        jTextArea1.setText("期号\t单价\t开奖状态\t开奖号码\t\t卖出注数\t奖池金额\n");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("往期发行彩票");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jScrollPane1.setViewportView(jTextArea1);

        jRefreshButton.setFont(new java.awt.Font("宋体", 0, 14)); // NOI18N
        jRefreshButton.setForeground(new java.awt.Color(51, 0, 255));
        ...
        jBackButton.setForeground(new java.awt.Color(0, 204, 204));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(148, 148, 148)
                        .addComponent(jBackButton, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(37, 37, 37)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jBackButton, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//            java.util.logging.Logger.getLogger(ShowLottFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new ShowLottFrame().setVisible(true);
//            }
//        });
//    }
